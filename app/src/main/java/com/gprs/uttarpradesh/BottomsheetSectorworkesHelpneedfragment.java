...
public class BottomsheetSectorworkesHelpneedfragment extends BottomSheetDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        view = inflater.inflate(R.layout.bottom_sheet_orphanneedhelp, container, false);
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validate()) {
                    ...
                    FirebaseDatabase.getInstance().getReference().child("Unorganisedsectorworkers").child("needhelp").child(pref.getString("user", "")).setValue(m);
        ...
        new BottomsheetSectorworkesHelpneedfragment.SetImage(imageView).execute("https://visus.azureedge.net/vis-dev-website/images/default-source/core-values/corevalues_6.png?sfvrsn=83397ff9_4");
        return view;
    }
