...
public class Labsfortestingandresults extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_labsfortestingandresults);

        spinner=findViewById(R.id.selectstate);
        gov=findViewById(R.id.gov);
        priv=findViewById(R.id.priv);
        listView=findViewById(R.id.labs);
        ...
        govtot=findViewById(R.id.govtotal);
        privtot=findViewById(R.id.privtotal);

        states=new ArrayList<>();
        states.add("Select State");
        dataAdapter = new ArrayAdapter<String>(this, R.layout.simple_spinner_item, R.id.txt_bundle, states);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if(!states.get(position).equals("Select State")) {
                    ...
                    Toast.makeText(Labsfortestingandresults.this, stateselected, Toast.LENGTH_LONG).show();
                    getstate();
                }
            }
        ...
        customLabsAdapter=new CustomLabsAdapter(this,labs);
        ...
        String jsonString="{\n" +
                ...
                "      \"Names of Private Institutes\":[\"Narayan Medical College, Sasaram\"]\n" +
                "          },\n" +
                "    \"TrueNat\":{\n" +
                ...
                "          },\n" +
                "    \"CB NAAT\":{\n" +
                "      \"Names of Government Institutes\":[\"State TB Training and Demonstration Centre, Jawaharlal Nehru Marg, Delhi Gate\",\"Department of Microbiology, National Institute of TB and Respiratory Diseases (NITRD), New Delhi\"],\n" +
                "      \"Names of Private Institutes\":[\"Dr P Bhasin Path Labs (P) Ltd, S 13 Greater Kailash Part 1, New Delhi\"]\n" +
                "          }\n" +
                "    }\n" +
                "  },\n" +
                "  \"8\":{\n" +
                ...
                "  \"Test Category\":{\n" +
                "    \"RT-PCR\":{\n" +
                "      \"Names of Government Institutes\":[\"Indira Gandhi Medical College, Shimla\",\"Dr. Rajendra Prasad Govt. Medical College, Tanda\",\"Central Research Institute, Kasauli\",\"Shri Lal Bahadur Shastri Govt. Medical College, Mandi\",\"CSIR Institute of Himalayan Bioresource Technology, Palampur\"],\n" +
                "      \"Names of Private Institutes\":[]\n" +
                "          },\n" +
                "    \"TrueNat\":{\n" +
                "      \"Names of Government Institutes\":[],\n" +
                ...
                "          },\n" +
                "    \"TrueNat\":{\n" +
                "      \"Names of Government Institutes\":[\"District Hospital, Bokaro\",\"District Hospital, Chatra\",\"District Hospital, Deoghar\",\"District Hospital, Dumka\",\"District Hospital, Garhwa\",\"District Hospital, Giridih\",\"District Hospital, Godda\",\"District Hospital, Hazaribag\",\"District Hospital, Kodarma\",\"District Hospital, Lathehar\",\"District Hospital, Pakur\",\"District Hospital, Palamu\",\"District Hospital, Pashchimi Singhbhum\",\"District Hospital, Ranchi\",\"District Hospital, Sahibganj\"],\n" +
                "      \"Names of Private Institutes\":[]\n" +
                "          },\n" +
                "    \"CB NAAT\":{\n" +
                "      \"Names of Government Institutes\":[],\n" +
                ...
                "      \"Names of Private Institutes\":[\"Dept of Pathology and Lab Medicine, Aster Medcity, Aster DM Healthcare Ltd, Kutty Sahib Road, Kothad, Cochin\",\"NIMS Medicity, Department of Laboratory Medicine, Aralumoodu, Neyyattinkara, Thiruvananthapuram\",\"Rajagiri Hospital Laboratory Services, Rajagiri Hospital, Chunangamvely, Aluva\"]\n" +
                "          }\n" +
                "    }\n" +
                "  },\n" +
                "  \"16\":{\n" +
                ...
                "      \"Names of Private Institutes\":[\"Sunflower Lab & Diagnostic Center, Keshav Kunj, Marve Road, Malad West, Mumbai\",\"Aditya Birla Memorial Hospital – Laboratory, Aditya Birla Marg, Chinchwad, Pune\",\"Dr. Jariwala Lab & Diagnostics LLP, 1st Floor, Rasraj Heights, Rokadia Lane, Off Mandpeshwar Road, Borivli (W), Mumbai\"]\n" +
                "          }\n" +
                "    }\n" +
                "  },\n" +
                "  \"17\":{\n" +
                ...
                "          },\n" +
                "    \"TrueNat\":{\n" +
                "      \"Names of Government Institutes\":[\"Imkongliba Memorial District Hospital, Mokokchung\",\"District Hospital, Mon\"],\n" +
                "      \"Names of Private Institutes\":[]\n" +
                "          },\n" +
                "    \"CB NAAT\":{\n" +
                "      \"Names of Government Institutes\":[],\n" +
                ...
                "          },\n" +
                "    \"TrueNat\":{\n" +
                "      \"Names of Government Institutes\":[\"SLN Medical College and Hospital, Koraput\",\"Tribal Field Unit of RMRC, Bhawanipatna, Kalahandi\",\"Tribal Field Unit of RMRC, Rayagada\"],\n" +
                "      \"Names of Private Institutes\":[]\n" +
                "          },\n" +
                "    \"CB NAAT\":{\n" +
                "      \"Names of Government Institutes\":[],\n" +
                "      \"Names of Private Institutes\":[\"Central Lab, AMRI Hospitals, Plot No 1, Khandagiri, Bhubaneswar\"]\n" +
                "          }\n" +
                "    }\n" +
                "  },\n" +
                "  \"23\":{\n" +
                ...
                "    \"CB NAAT\":{\n" +
                "      \"Names of Government Institutes\":[],\n" +
                "      \"Names of Private Institutes\":[\"Gian Life Care Ltd, 7/216(6), Swaroop Nagar, Kanpur\"]\n" +
                "          }\n" +
                "    }\n" +
                "  },\n" +
                "  \"30\":{\n" +
                ...
                "  \"Test Category\":{\n" +
                "    \"RT-PCR\":{\n" +
                "      \"Names of Government Institutes\":[\"Govt. Medical College, Haldwani\",\"All India Institute of Medical Sciences, Rishikesh\",\"Doon Medical College, Dehradun\",\"Veer Chandra Singh Garhwali Govt. Institute of Medical Science & Research, Srinagar, Pauri, Garhwal\"],\n" +
                ...
                "          },\n" +
                "    \"TrueNat\":{\n" +
                "      \"Names of Government Institutes\":[\"IRL, STNM Hospital, Gangtok\"],\n" +
                "      \"Names of Private Institutes\":[]\n" +
                "          },\n" +
                "    \"CB NAAT\":{\n" +
                "      \"Names of Government Institutes\":[],\n" +
