...
public class BottomsheetOrphanHelpneedfragment extends BottomSheetDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validate()) {
                    ...
                    FirebaseDatabase.getInstance().getReference().child("Orphans").child("needhelp").child(pref.getString("user", "")).setValue(m);
        ...
        new BottomsheetOrphanHelpneedfragment.SetImage(imageView).execute("https://visus.azureedge.net/vis-dev-website/images/default-source/core-values/corevalues_6.png?sfvrsn=83397ff9_4");
        return view;
    }
