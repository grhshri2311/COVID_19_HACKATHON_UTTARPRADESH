...
public class BottomsheetMaterialCollectionformfragment extends BottomSheetDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        view = inflater.inflate(R.layout.bottom_sheet_materialcollectionform_lyout, container, false);
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validate()) {
                    ...
                    FirebaseDatabase.getInstance().getReference().child("MaterialCollection").child("distribute").child(pref.getString("user", "")).child(currentDateTime).setValue(m);
        ...
        new BottomsheetMaterialCollectionformfragment.SetImage(imageView).execute("https://www.freepngimg.com/thumb/grocery/54018-9-grocery-free-hq-image.png");
        return view;
    }
    ...
    public boolean validate() {
        ...
        if (radioGroup.getCheckedRadioButtonId() == -1) {
            ...
            radio.setError("Select material type");
        ...
        if (dob.getText().toString().isEmpty()) {
            TextInputLayout dobl = view.findViewById(R.id.doblayout);
            dobl.setError("Enter Date and Time");
        ...
        if (profileuploaded) {
            Toast.makeText(getContext(), "Upload photo of materials", Toast.LENGTH_SHORT).show();
            return false;
        }
        return true;
    }
